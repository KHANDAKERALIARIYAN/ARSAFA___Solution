"""
Django settings for ARSAFA___SOLUTION project.
...
ALLOWED_HOSTS = ['arsafa-solution.onrender.com', 'localhost', '127.0.0.1','*']
...
ROOT_URLCONF = 'ARSAFA___SOLUTION.urls'
...
WSGI_APPLICATION = 'ARSAFA___SOLUTION.wsgi.application'
